...
class IconeMeteo
{
  public:
    ...
    void actualiser(uint8_t codeMeteo);

  private:
    static constexpr int16_t LARGEUR = 150;
    static constexpr int16_t HAUTEUR = 130;

    static constexpr int16_t DECALAGE_X = 145;
    ...
    void effacer();
    void dessiner(TypeIconeMeteo type);
